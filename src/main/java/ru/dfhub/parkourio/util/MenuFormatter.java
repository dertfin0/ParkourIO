...
public class MenuFormatter {
    ...
    private static Map<Integer, List<Integer>> format = new HashMap<>() {{
        ...
        put(5, List.of(11, 12, 13, 14, 15));
        put(6, List.of(11, 12, 13, 14, 15, 22));
        put(7, List.of(10, 11, 12, 13, 14, 15, 16));
        put(8, List.of(4, 11, 12, 13, 14, 15, 21, 23));
        put(9, List.of(3, 5, 11, 12, 13, 14, 15, 21, 23));
        put(10, List.of(3, 4, 5, 11, 12, 13, 14, 15, 21, 23));
